...
/**
 * LIGHTWEIGHT LAYER: CAROUSEL_TEMPLATES
 * Used only for the landing page carousel.
 */
export const CAROUSEL_TEMPLATES: TemplateCardData[] = [
  {
    ...
    imageSrc: "https://i.pinimg.com/1200x/2e/d0/f7/2ed0f792f0e4561e21bffaa88d9f50f1.jpg",
    imageAlt: "creative cafe-style resume template with rounded profile image and bold retro typography",
    badge: "Creative",
    badgeVariant: "retro",
  },
  {
    ...
    imageSrc: "https://i.pinimg.com/1200x/ca/22/c0/ca22c023a21b42dc05670921506a7cc9.jpg",
    imageAlt: "Natural and organic aesthetic with earthy tones and simple, clean lines",
    badge: "Minimalist",
    badgeVariant: "green",
  },
  {
    ...
    imageSrc: "https://i.pinimg.com/1200x/c0/5a/20/c05a20d6a51a810e92d3bcd7d814e4fd.jpg",
    imageAlt: "Vintage-inspired resume template with a warm color scheme and classic design elements",
    badge: "Classic",
    badgeVariant: "greasy",
  }
];
...
/**
 * LIGHTWEIGHT LAYER: GRID_TEMPLATES
 * Used for the main /templates catalog.
 */
