 ...
 * 
 * Responsible for:
 * - Displaying a live preview of the resume
 * - Showing the selected template
 * - Rendering resume data in the A4 format
 * - Providing zoom controls
 * - Showing decorative elements (stickers, notes)
 * 
 * Props:
 * - data: Current resume data (ResumeData)
 * - templateId: The selected template identifier
 * 
 * This component is read-only for preview.
 * Data updates come from EditorForm component.
 */
export default function ResumeCanvas({ data, templateId }: ResumeCanvasProps) {
    ...
    <section className="hidden lg:flex flex-col grow bg-surface-container relative overflow-hidden canvas-bg">
      ...
      <div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">
        <div className="bg-white px-4 py-2 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] font-bold text-xs uppercase flex gap-4">
          ...
          <span className="text-secondary">Template: &quot;{templateId}&quot;</span>
        </div>
