 ...
 * 
 * Responsible for:
 * - Rendering form inputs for resume data
 * - Managing form state locally (e.g., sass level)
 * - Calling onChange callback when data changes
 * - Providing clear sections for user input
 * 
 * Props:
 * - data: Current resume data (ResumeData)
 * - onChange: Callback when user updates data
 */
