  ...
  return (
    <div className="group flex flex-col bg-white border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all overflow-hidden brutalist-card">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <p className="text-sm font-medium mb-8 flex-grow font-body">
          {template.description}
        </p>
        <Link
          href={`/editor?template=${template.id}`}
          className="w-full bg-black text-white py-4 font-black uppercase tracking-widest text-lg border-2 border-black hover:bg-primary transition-colors text-center block active:translate-x-[2px] active:translate-y-[2px]"
        >
          Select Vibe
        </Link>
      </div>
